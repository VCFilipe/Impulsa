...
const NavLink: React.FC<NavLinkProps> = ({
  ...
  return (
    ...
    >
      <span
        className={`transition-colors ${isCollapsed ? "" : "mr-2.5"} ${
          isActive
...
const NavGroup: React.FC<NavGroupProps> = ({
  ...
  if (isCollapsed) {
    return (
      <div
        title={label}
        className="flex items-center justify-center px-2.5 h-10 text-gray-500 dark:text-gray-400"
      >
        {icon}
      </div>
    );
    ...
    <div>
      ...
      >
        <div className="flex items-center">
          <span className="mr-2.5 text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300">
            {icon}
          </span>
...
const MainLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("announcementsUpdated", updateUnreadCount);
  }, []);
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
      <aside
        ...
        } transition-all duration-300 ease-in-out shadow-sm overflow-x-hidden`}
      >
        <div
        ...
        >
          <Link
            ...
            title={isCollapsed ? APP_NAME : undefined}
          >
            <img
              src="https://i.postimg.cc/MTL4TC0C/logo.png"
              alt={APP_NAME}
        ...
        <nav className="flex-grow p-2.5 space-y-1.5 overflow-y-auto overflow-x-hidden">
          ...
          <NavGroup
            ...
            isCollapsed={isCollapsed}
            basePath="/portal"
            initialOpen={location.pathname.startsWith("/portal")}
          >
            <NavLink
              to="/policies"
          ...
          >
            <NavLink
              to="/ai-accelerators/prompts"
              icon={<ClipboardList size={18} />}
              label="Prompts"
              isCollapsed={isCollapsed}
            />
            <NavLink
              to="/ai-accelerators/chat"
