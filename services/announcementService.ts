  ...
  return [
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8dGVjaG5vbG9neSUyMGRhdGElMjBjZW50ZXJ8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60",
      isPinned: true,
    ...
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1586953208448-3151cf797f10?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGhvZWFyY2h8MTF8fGhvbmUlMjBvZmZpY2V8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60",
      isPinned: true,
    ...
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1521791136064-7986c2920216?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y2VsZWJyYXRpb258ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60",
      isPinned: false,
      isRead: false, // Adicionado
    ...
    },
    {
      ...
      content:
        "Informamos que o sistema de CRM foi atualizado na última noite. As novas funcionalidades incluem um dashboard personalizável e integração aprimorada com o funil de vendas. Um guia rápido foi enviado por e-mail e o treinamento completo está agendado para a próxima semana. Em caso de dúvidas, contate o suporte de TI.",
      category: AnnouncementCategory.TECNOLOGIA_NOVOS,
      authorId: "ti-dept",
      authorName: "Departamento de TI",
      isPinned: false,
    ...
    },
    {
      id: "ann-6",
      title:
        "Lembrete: Prazo Final para Inscrição no Programa de Desenvolvimento de Líderes",
      content:
        "Lembramos a todos os interessados que o prazo final para inscrição no Programa de Desenvolvimento de Líderes é nesta sexta-feira, 26/07. Não perca a oportunidade de aprimorar suas habilidades de liderança. Inscrições pelo Portal RH.",
      category: AnnouncementCategory.RH_COMUNICA,
      authorId: "rh-dept",
      authorName: "Recursos Humanos",
      isPinned: false,
    ...
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8aGFja2F0aG9ufGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60",
      isPinned: false,
      isRead: true, // Adicionado
    ...
    },
    {
      ...
      content:
        "A equipe do Projeto Alpha tem o prazer de anunciar a conclusão bem-sucedida da fase de testes da nova plataforma de e-commerce. Agradecemos a todos os testadores voluntários pelo feedback valioso. Próximos passos: ajustes finais e preparação para o lançamento em Setembro.",
...
export const addAnnouncement = (
  data: Omit<
    Announcement,
    "id" | "createdAt" | "updatedAt" | "authorId" | "authorName" | "isRead"
  >
): Announcement => {
...
export const updateAnnouncement = (updatedData: Announcement): Announcement => {
  ...
  const now = new Date().toISOString();
  const originalAnnouncement = announcements.find(
    (a) => a.id === updatedData.id
  );
  ...
  const finalUpdatedData = {
    ...
    isRead:
      originalAnnouncement?.id === updatedData.id
        ? updatedData.isRead
        : originalAnnouncement?.isRead || false, // Preserve original isRead unless explicitly changed
  };

  announcements = announcements.map((ann) =>
    ann.id === finalUpdatedData.id ? finalUpdatedData : ann
  );
...
export const getRecentUnreadAnnouncements = (
  limit: number = 3
): Announcement[] => {
...
export const getRecentNonPinnedAnnouncements = (
  limit: number = 5
): Announcement[] => {
  return getAnnouncements()
    .filter((ann) => !ann.isPinned)
